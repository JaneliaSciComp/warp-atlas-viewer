...
Pinning exactly one gene in **Transcriptomics** colors the plasma ramp by that gene's raw FISH spot count per cell. This is the conventional single-gene expression map.
