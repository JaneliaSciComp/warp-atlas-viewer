...
| **Settings** | Point size and ghost visibility, rendering options (3D ambient occlusion, AO strength/radius, opaque active cells), stim cutoffs, swim cutoffs, activity anchors, gene-spot ceiling, multi-gene mode, gene predicate. |
