...
| Group | Examples |
|---|---|
| **Filter cards** | Color scheme, region palette, pinned gene indices, gene OR/AND, subtype index, selected stimuli, stim mode, swim mode, region, atlas region (mapzebrain), specimen, show-unassigned-region toggle. |
