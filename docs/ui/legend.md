...
- **Region** uses a 17-color palette sampled directly from the paper's region figure legend, ordered anterior → posterior. *Unassigned* (index 0) renders as a dedicated neutral gray rather than a hue.
